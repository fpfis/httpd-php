...
RUN a2enmod proxy_fcgi rewrite headers && a2dismod fcgid && a2disconf php7.2-fpm && a2dissite 000-default && phpdismod exif readline shmop sysvmsg sysvsem sysvshm wddx igbinary
