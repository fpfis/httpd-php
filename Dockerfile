...
RUN phpdismod exif readline shmop sysvmsg sysvsem sysvshm wddx igbinary ii; a2enmod proxy_fcgi rewrite headers; a2disconf php7.2-fpm other-vhosts-access-log; a2dissite 000-default
