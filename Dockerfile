...
ENV ENVIRONMENT=prd TIMEOUT=120 DOCUMENT_ROOT="/var/www/html" PORT=8080 APACHE_EXTRA_CONF_DIR="" APACHE_ERROR_LOG="/var/log/apache.err" APACHE_ACCESS_LOG="/var/log/access" ALLOWOVERRIDE="none"
ENV PHP_VERSION="7.2" FPM_MAX_CHILDREN=100 FPM_START_SERVERS=20 FPM_MIN_SPARE_SERVER=10 FPM_MAX_SPARE_SERVER=30 FPM_MAX_REQUESTS=500 PHP_UPLOAD_MAX_FILESIZE="200M" PHP_POST_MAX_SIZE="220M" PHP_SESSION_PATH="/tmp" PHP_ERROR_LOG="/var/log/php.err" PHP_DISPLAY_ERRORS="Off" PHP_OPCACHE="On" PHP_DEPENDENCIES="common cli fpm soap bz2 opcache zip xsl intl imap mbstring ldap mysql gd memcached redis curl sqlite bcmath xdebug"
